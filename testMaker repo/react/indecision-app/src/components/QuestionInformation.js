  ...
  <label className= "text-color">Informacije o pitanju </label>
        <button type="button" className="close" onClick={this.props.closeQuestionInformation}  data-dismiss="modal">x</button>
                ...
                <div className="row " >
                    <div className={this.state.answerVisibility !== true ? 'col-lg-12 form-padding  ' : 'col-lg-6 form-padding '} >
                        ...
                        <form  >
                            ...
                            <div className="row">
                                <div className="form-group offset-lg-3 col-lg-6 offset-lg-3">
                                    <button type="button" onClick={this.openChangeQuestionDiv} className = "rounded-button btn button-secondary-color margin-left-button ">Promijeni </button>
                                    {this.state.question.type === '/c' && <button type="button" className= "rounded-button btn button-primary-color margin-left-button" onClick={this.getAnswersForQuestion}>Odgovori </button>}
                                </div>
                            </div>
                        ...
                        <div className='offset-lg-3 col-lg-6  offset-lg-3 answer-padding '>
                            <form onSubmit={this.changeQuestion}>
                                ...
                                <div className="row">
                                    <div className="form-group offset-lg-3 col-lg-6 offset-lg-3">
                                        <label>Tekst pitanja:</label>
                                        <input type="text" name="questionText" defaultValue={this.state.question.text} className="form-control form-control-lg "  />
                                    </div>
                                </div>
                                ...
                                <div className="row">
                                    <div className="form-group offset-lg-7 col-lg-5">
                                        <button className="rounded-button btn button-primary-color">Sacuvaj</button>
                                    </div>
                                </div>
            ...
            <div className=" offset-lg-10 col-lg-2 close-bottom  ">
              <button onClick={this.props.closeQuestionInformation} className="btn rounded-button button-primary-color " >Close </button>
            </div>
          </div>
